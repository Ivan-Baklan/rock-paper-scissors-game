...
import logoSVG from '../../assets/img/logo-bonus.svg'
import { selectBonusGameChoice } from "../../store/features/bonusGameSlice"

export default function BonusHeader() {
    const { score } = useAppSelector(selectBonusGameChoice)
    return (
